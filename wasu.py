    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] XM9RTY WASU K1NG {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " XM9RTY WASU K1NG TOOL ")
    print(Fore.CYAN + "BHAT WASU XWD INXIIDE")
    print(Fore.MAGENTA + "─────────────────────────────────────────😻")
    print(Fore.CYAN + " FACEBOOK: BHAT WASU X AZR'W")
    print(Fore.MAGENTA + "─────────────────────────────────────────😻")
    print(Fore.CYAN + " BROTHERS: WASU X ERIIC")
